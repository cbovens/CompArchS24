...
add wave -noupdate -divider -height 32 "Reset"
add wave -b stimulus/dut/reset_b
add wave -noupdate -divider -height 32 "Input"
add wave -b stimulus/dut/In
add wave -noupdate -divider -height 32 "Output"
add wave -b stimulus/dut/Out
add wave -noupdate -divider -height 32 "Current State"
add wave -h stimulus/dut/state
add wave -noupdate -divider -height 32 "Next State"
add wave -h stimulus/dut/nextState
